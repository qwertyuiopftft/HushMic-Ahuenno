...
personal-speaker extraction and phrase triggering.
...
- `scripts/train_bc_phrase.py` and `scripts/hushmic_phrase_trigger.py` — an
  optional phrase detector/replacement experiment. It adds buffering and is
  not recommended for latency-sensitive calls or games.
